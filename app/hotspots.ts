// Hotspot definitions for the magical library - Verified positions
...
export const HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    ...
    y: 22.0,
    label: "Dried Bouquet",
    description: "A beautiful dried bouquet hanging from the ceiling beams...",
  },
  {
    id: "globe",
    x: 61.0,
