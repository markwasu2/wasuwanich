// Hotspot definitions - FINAL PRECISION-VERIFIED POSITIONS
...
export const HOTSPOTS: Hotspot[] = [
  // TABLE FOREGROUND - PRECISION VERIFIED
  {
    id: "sleeping-cat",
    x: 42.0,
    y: 67.0,
  ...
  // HANGING ITEMS - PRECISION VERIFIED
  {
  ...
  // MIDDLE SHELVES - PRECISION VERIFIED
  {
    id: "globe",
    x: 61.0,
    y: 37.0,
  ...
  // RIGHT WINDOW - PRECISION VERIFIED
  {
    id: "hanging-ivy-top",
    x: 84.0,
    y: 17.0,
